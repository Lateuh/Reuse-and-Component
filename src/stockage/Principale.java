...
public class Principale
{
	public static void main(String[] args) 
	{
		...
		*/
		...
		File f = new File("Martini.class","martiniofnziejfbijsqbfi") ;
		File f2 = new File("Ricard","ricard") ;
		Directory d2 = new Directory("Eau") ;
		File f3 = new File("Glacons.class","glaconsizbfiuzfuozno") ;
		...
		File f4 = new File("Duval","duvalfoavoiznpvionzinpzn") ;
